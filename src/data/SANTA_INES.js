export const SANTA_INES = {
	...
	styles: {
		...
		hoverTextColor: 'hover:text-pale-purple',
		hoverBackgroundColor: 'hover:bg-pale-purple',
		groupHoverTextColor: 'group-hover:text-pale-purple',
		fillColor: 'fill-pale-purple',
		borderColor: 'border-pale-purple'
	},
	image: {},
	schedule: [
		{
