export const CENTENARIO = {
	...
	links: [{ name: 'web', url: 'https://teatrocentenario.cl/' }, { name: 'ticket', url: 'https://www.portaldisc.com/evento/arc2023' }],
	styles: {
			...
			events: [
				{
					...
					list: [
						{
							title: 'Discografía:',
							text: ['Almismotiempo (2009)', 'Panal (2012)', 'Mala Madre (2015)', 'Rey (2021)']
						}
					]
				},
				{
					...
					list: [
						{
							...
							text: [
								'Gabriel Tapia (batería y secuencias)',
								'Jorge Cortés (guitarra)',
								'Fabian Zorricueta (sintetizador y voz)',
								'Cris Vera (Guitarra y sintetizador)',
								'Francisco Pinto (Bajo)'
							]
						}
					]
				},
		...
		},
		{
			...
			events: [
				...
				},
				{
					...
					list: [
						{
							title: 'Flamantës está conformado por:',
							text: ['Zacarías Pastén', 'Francisco Pinto', 'Cristian Vera', 'Esteban Guzmán']
						}
					]
				},
				{
