export const CENTENARIO = {
	...
	direction: 'Gregorio Cordovez N° 391, La Serena',
	extract:
	...
	textColor: 'group-hover:text-black-pink',
	locationImage: {
		url: '',
	...
	artists: [
		{
			...
			extra: {
				text: 'Su discografía en estudio como artista en solitario está compuesta por los siguientes trabajos:',
				subTitle: '',
				list: ['Almismotiempo (2009)', 'Panal (2012)', 'Mala Madre (2015)', 'Rey (2021)'],
			},
		},
		{
			id: 'ases-falsos',
			...
			links: [
				{ name: 'webSite', url: 'https://asesfalsos.cl' },
		...
		},
		{
			id: 'marineros',
			name: 'Marineros',
			image: { url: '', position: { marginTop: '3rem' }, alt: 'Imagen de la banda nacional Marineros' },
			links: [
		...
		},
		{
			id: 'yorka',
			name: 'Yorka',
			image: { url: '/centenario/yorka.jpeg', position: { marginTop: '4rem' }, alt: 'Imagen de la banda nacional Yorka' },
			links: [
		...
		},
		{
			id: 'flamantes',
			name: 'Flamantës',
			image: { url: '/centenario/flamantës.jpg', position: { marginTop: '8rem' }, alt: 'Imagen de la banda regional Flamantës' },
			links: [],
			description:
		...
		},
		{
			...
			image: { url: '/centenario/pájarxs-de-tierra.jpg', position: { marginTop: '-1rem' }, alt: 'Imagen de la banda regional Pájaros de Tierra' },
			links: [{ name: 'instagram', url: 'https://www.instagram.com/pajarxsdetierra/' }],
			description:
		...
		},
		{
			id: 'sequia',
			name: 'Sequía',
			image: { url: '/centenario/sequía.jpg', position: { marginTop: '3rem' }, alt: 'Imagen de la banda regional Sequía' },
			links: [],
			description:
