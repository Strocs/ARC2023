				...
				events: [
					{
						id: 'camila-moreno',
						name: 'Camila Moreno',
						image: { url: '', position: { marginTop: '3rem' }, alt: 'Imagen de la artista nacional Camila Moreno' },
						links: [
							{ name: 'web', url: 'https://www.camila-moreno.com/' },
							{ name: 'spotify', url: 'https://open.spotify.com/artist/0SJy1J0FgP21lbvGBMKT8H' },
							{ name: 'instagram', url: 'https://www.instagram.com/camila_moreno_' },
							{ name: 'facebook', url: 'https://www.facebook.com/camilamorenoficial' },
						],

						description:
							'El sentido del riesgo es la característica distintiva de la cantante, autora y compositora Camila Moreno, expresada en un acercamiento personal a los sonidos acústicos, a la electricidad del rock y la producción electrónica. Ha conseguido difusión internacional, buscando un vínculo entre su cantautoría y procesos sociales más amplios, situándose entre las voces destacadas de una generación de cantantes chilenos que comparten una inclinación a la raíz folclórica por instinto y un canto personal y testimonial al mismo tiempo.\nAntes de iniciar su camino como solista, la artista participó de distintos proyectos, como Princesa Leia Project, junto al músico y productor, Gerardo Figueroa (2003 – 2005), el dúo Caramelitus, en el que trabajó con el músico Tomás Preuss (2006) y las bandas de raíz latinoamericana Cúchara (2006-2008) y Las Polleritas (2007).\nTras su debut solista con el trabajo Almismotiempo (2009), la artista comenzó a ganar notoriedad, tanto en Chile como en el extranjero, con grandes hitos como la nominación de su tema “Millones” en la categoría “mejor canción alternativa” de los Latin Grammy del año 2009; presentaciones en grandes escenarios de la música nacional, como el Festival del Huaso del Olmué en 2010 y el Festival de la Canción de Viña del Mar en 2011; su primera gira por Europa en 2012, con presentaciones en algunas de las ciudades más importantes del continente, como Berlín, Barcelona y París y su debut en los festivales Lollapalooza Chile y Rock al Parque de Colombia en el mismo año.',
						extra: {
							subTitle: '',
							list: [{ title: 'Discografía:', text: ['Almismotiempo (2009)', 'Panal (2012)', 'Mala Madre (2015)', 'Rey (2021)'] }],
						},
					},

					{
						...
						image: { url: '/centenario/pajarxs-de-tierra.webp', position: { marginTop: '-1rem' }, alt: 'Imagen de la banda regional Pájaros de Tierra' },
						links: [
							{ name: 'youtube', url: 'https://www.youtube.com/@pajarxsdetierra3633' },
							{ name: 'instagram', url: 'https://www.instagram.com/pajarxsdetierra/' },
						],
						description:
				...
				events: [
					{
						id: 'yorka',
						name: 'Yorka',
						image: { url: '/centenario/yorka.webp', position: { marginTop: '4rem' }, alt: 'Imagen de la banda nacional Yorka' },
						links: [
							{ name: 'spotify', url: ' https://open.spotify.com/artist/71bG6LIwKMYALxV8WuIezn' },
							{ name: 'instagram', url: 'https://www.instagram.com/yorkayork' },
					...
					},
					{
						id: 'hesper',
						name: 'Hesper',
						image: { url: '/centenario/hesper.webp', position: { marginTop: '3rem' }, alt: 'Imagen de la banda regional Sequía' },
						links: [
							{ name: 'spotify', url: 'https://open.spotify.com/artist/1zGDpCu4CIMZCFfE9FeaEL' },
							{ name: 'bandcamp', url: 'https://hesperbanda.bandcamp.com/' },
							{ name: 'instagram', url: 'https://www.instagram.com/hesperbanda/' },
...

					{
						id: 'luminar',
						name: 'Luminar',
						image: { url: '/centenario/luminar.webp', position: { marginTop: '3rem' }, alt: 'Imagen de la banda nacional Ases Falsos' },
						links: [
				...
				events: [
					{
						id: 'ases-falsos',
						name: 'Ases Falsos',
						image: { url: '', position: { marginTop: '3rem' }, alt: 'Imagen de la banda nacional Ases Falsos' },
						links: [
							{ name: 'web', url: 'https://asesfalsos.cl' },
							{ name: 'spotify', url: 'https://open.spotify.com/artist/5duXcUlwdTvVHJTLWJa2j1' },
							{ name: 'instagram', url: 'https://www.instagram.com/asesfalsos' },
					...
					},
					{
						id: 'flamantes',
						name: 'Flamantës',
						image: { url: '/centenario/flamantës.webp', position: { marginTop: '8rem' }, alt: 'Imagen de la banda regional Flamantës' },
						links: [
							{ name: 'spotify', url: 'https://open.spotify.com/artist/3kropYxIZkoH8nSlWbtPmb' },
							{ name: 'youtube', url: 'https://www.youtube.com/channel/UCxGD8VbIpyTFRsJ78My6hkA' },
							{ name: 'instagram', url: 'https://www.instagram.com/flamantesmusica/' },
						],
						description:
							'Banda chilena de indie pop, que nace en 2019 como un proyecto conformado por reconocidos músicos de la región de Coquimbo, con marcada influencia en el soul y el funk de los 70`s, Flamantës presenta un espectáculo ecléctico y bailable.\nRecientemente, Flamantës representó a la región de Coquimbo en el festival Rockódromo 2022 con gran recibimiento por parte del público en Valparaíso, donde dieron inicio a la gira de lanzamiento de su nuevo disco “Tres tristes tigres”, presentando entre otros, “La ciudad de las bestias” y “Fulgor”, ambos singles y videoclips inspirados en la poesía y literatura latinoamericana exploran la proyección del fantasma del espíritu siendo esta la marca visual del nuevo álbum.\nActualmente la banda se prepara para el lanzamiento de “Máscara”, tercer sencillo de Tres tristes tigres.',
						extra: {
							subTitle: '',
							list: [{ title: 'Flamantës está conformado por:', text: ['Zacarías Pastén', 'Francisco Pinto', 'Cristian Vera', 'Esteban Guzmán'] }],
						},
					},
					{
						id: 'sequia',
						name: 'Sequía',
						image: { url: '/centenario/sequía.webp', position: { marginTop: '3rem' }, alt: 'Imagen de la banda regional Sequía' },
						links: [],
						description:
							'Sequía nace el año 2015 en la ciudad de Coquimbo. Su sonido se inclina por el Post-Rock, el Post-Hardcore y el Rock Progresivo, aunque muchas veces bordean lo más experimental. Sus canciones son reflejo de las diversas influencias aportadas por cada uno de sus integrantes.\nEn sus inicios (2015), se presentaron en distintos lugares y festivales en las ciudades de Coquimbo y La Serena. En el año 2016 - 2017, participan en festivales en Santiago, además de comenzar la grabación de su primer EP en Estudio 19, en Coquimbo, proceso que terminó en 2018.\nEn ese año, Sequía cambia de formación, lo cual genera el cierre de un ciclo y el cambio en su sonoridad, en donde también se incorporan nuevos elementos como Kaoss Pad y Loops en vivo, con lo que buscan lograr un sonido sólido y propio.\nEn el año 2019, se lanzó en formato digital y físico su primer trabajo de estudio titulado ‘’Sentidos’’. Durante ese año, son partícipes del festival cultural y medioambiental ‘’Chango Rock Fest II’’ y del Día de La Música Chilena en la Plaza de Armas de la ciudad de La Serena, compartiendo escenario con destacados artistas nacionales y regionales.\nEn el año 2021, la banda forma parte del festival Rockódromo junto a grupos regionales, y en 2022, se presentan en el festival Astromúsica en el Teatro Municipal de Ovalle, instancia en que Sequía estrena canciones en su nuevo formato como banda, donde incorporan una guitarra eléctrica adicional y una serie de sintetizadores que le dan un carácter más experimental a su música. En la actualidad, Sequía se encuentra produciendo su nuevo material, el cual se estrenará en verano de 2023.',
						extra: {
							subTitle: '',
							list: [
								{
									title: 'Sequía es:',
									text: [
										'Sebastián Torres - Composición, voz principal, guitarra eléctrica y sintetizador.',
										'Juan Carlos Ossandón - Composición, coros, bajo eléctrico y sintetizadores.',
										'Alfredo Bahamondes - Composición, coros y guitarra eléctrica.',
										'Jorge Veas - Composición, batería y diseño gráfico.',
									],
								},
							],
						},
